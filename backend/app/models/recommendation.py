...
class ProcurementRecommendation(Base):
    ...
    score_s: Mapped[float | None] = mapped_column(Numeric(6, 3))
    score_c: Mapped[float | None] = mapped_column(Numeric(6, 3))
    score_v: Mapped[float | None] = mapped_column(Numeric(6, 3))
    score_l: Mapped[float | None] = mapped_column(Numeric(6, 3))
    score_p: Mapped[float | None] = mapped_column(Numeric(6, 3))
    score_e: Mapped[float | None] = mapped_column(Numeric(6, 3))
