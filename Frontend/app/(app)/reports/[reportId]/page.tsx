...
export default function ReportDetailPage() {
  ...
  return <div className="min-h-screen bg-slate-50 text-slate-900"><header className="flex h-16 items-center justify-between lg:justify-end border-b border-slate-200 bg-white px-6"><Link href="/dashboard" className="flex items-center gap-2.5 lg:hidden"><div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-cyan-500 text-white"><ShieldAlert className="h-4 w-4" /></div><span className="font-semibold">SupplyGuard</span></Link><Button onClick={() => window.print()} variant="outline" className="no-print border-slate-200"><Download className="mr-2 h-4 w-4" />PDF 저장</Button></header>
